    ...
    <footer className="bg-white py-12">
      <div className="max-w-[1440px] mx-auto px-20">
        <div className="grid grid-cols-5 gap-8">
          <div><Logo /><div className="flex gap-3 mt-4"><a href="#" className="text-gray-400 hover:text-gray-600"><FacebookIcon size={18} /></a><a href="#" className="text-gray-400 hover:text-gray-600"><TwitterIcon size={18} /></a><a href="#" className="text-gray-400 hover:text-gray-600"><GithubIcon size={18} /></a><a href="#" className="text-gray-400 hover:text-gray-600"><TelegramIcon size={18} /></a><a href="#" className="text-gray-400 hover:text-gray-600"><InstagramIcon size={18} /></a><a href="#" className="text-gray-400 hover:text-gray-600"><LinkedInIcon size={18} /></a></div></div>
